...
public class Main {
    ...
    public static void main(String[] args) {
        //indice da posicao, indice da posicao, valor da posicao, se é fixed ou n
    ...
    private static void startGame(Map<String, String> positions) {
        if (nonNull(board)) {
            System.out.println("O jogo já foi inciado.");
            return;
        }
    ...
    private static int runUntilGetValidNumber(final int min, final int max) {
        ...
        while (current < min || current > max) {
            System.out.printf("Informe um númer entre %s e %s\n", min, max);
